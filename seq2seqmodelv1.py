# -*- coding: utf-8 -*-
"""
Majority of the code has been referenced from https://pytorch.org/tutorials/intermediate/seq2seq_translation_tutorial.html#sphx-glr-intermediate-seq2seq-translation-tutorial-py
Using embeddings generated from vocabulary in the data
...
def trainIters(encoder, decoder, n_iters, print_every=100, plot_every=100, learning_rate=0.01):
    ...
    training_pairs = [tensorsFromPair(train_data.ix[random.choice(row_index)])
